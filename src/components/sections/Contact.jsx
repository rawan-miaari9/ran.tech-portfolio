...
export const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Debug: verify env vars are loaded (remove after testing)
    ...
    if (!serviceId || !templateId || !publicKey) {
      ...
      alert(
        "EmailJS config missing. Check your .env file and restart the dev server (npm run dev)."
      );
      return;
    }
    ...
    emailjs
      ...
      .catch((error) => {
        ...
        // EmailJS error often has .text property with details
        const details = error?.text || error?.message || JSON.stringify(error);
